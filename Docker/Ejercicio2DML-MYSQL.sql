...
VALUES ('9554623P', 'Miguel', 'Cervantes', 'Rodríguez', 10);
...
-- No se puede modificar ya que viola una constraint
-- Solucion:
ALTER TABLE EMPLEADO DROP CONSTRAINT FK_Codigo_Dep;
ALTER TABLE EMPLEADO ADD CONSTRAINT FK_Codigo_Dep FOREIGN KEY (codigo_departamento) REFERENCES DEPARTAMENTO(codigo) ON UPDATE CASCADE;
UPDATE DEPARTAMENTO
SET codigo = 30
